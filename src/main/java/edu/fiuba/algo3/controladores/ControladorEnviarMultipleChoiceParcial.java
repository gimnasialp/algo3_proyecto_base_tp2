...
public class ControladorEnviarMultipleChoiceParcial extends ControladorPreguntasJuego implements EventHandler<ActionEvent> {
    private ArrayList<Integer> opcionesSeleccionadas;

    public ControladorEnviarMultipleChoiceParcial(Stage stagePrincipal, PantallaPrincipal pantallaPrincipal, AlgoHoot algoHoot) {
