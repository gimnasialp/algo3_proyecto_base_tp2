...
public class ControladorEnviarMultipleChoicePenalidad extends ControladorPreguntasJuego implements EventHandler<ActionEvent> {
    private ArrayList<Integer> opcionesSeleccionadas;

    public ControladorEnviarMultipleChoicePenalidad(Stage stagePrincipal, PantallaPrincipal pantallaPrincipal, AlgoHoot algoHoot) {
