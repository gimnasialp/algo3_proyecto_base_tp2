...
public class BotonOpcionMultipleChoicePenalidad extends CheckBox {
    private String opcion;
    private int indice;

    public BotonOpcionMultipleChoicePenalidad(String opcion, int indice, ControladorEnviarMultipleChoicePenalidad controladorRespondioUsuario) {
        this.opcion = opcion;
        this.indice = indice;
