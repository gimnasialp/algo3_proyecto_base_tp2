...
public class VistaMultipleChoiceParcial extends StackPane {
    ...
    private VBox armarOpciones(VBox cajaPregunta, Pregunta pregunta, ControladorEnviarMultipleChoiceParcial controlador) {
        ...
        for (int i = 0; i < opciones.size(); i++) {
            ...
            BotonOpcionMultipleChoiceParcial boton = new BotonOpcionMultipleChoiceParcial(opcion, i, controlador);
