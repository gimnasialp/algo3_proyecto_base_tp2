...
public class PartidaTest {
    ...
    public void Test01RondaProcesaCorrectamenteLasRespuestasVF() {
        ...
        VerdaderoFalsoClasico unVerfaderoFalso = new VerdaderoFalsoClasico("Argentina es el actual Campeon Mundial", respuestas);
        respuestas = new ArrayList<>(Arrays.asList(correcta, incorrecta));
