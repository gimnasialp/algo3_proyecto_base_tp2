...
import edu.fiuba.algo3.modelo.Lector.ParserRespuesta;
...
public class JugadorRespondePreguntaTest {
    ...
    public void unJugadorRespondeIncorrectamenteUnaPreguntaVerdaderoFalsoClasicoYRecibeCeroPuntos() {
        ...
        Respuesta respuestaDelJugador = new RespuestaVerdaderoFalsoClasico(1);
    ...
    public void unJugadorRespondeCorrectamenteDosPreguntasVerdaderoFalsoClasicoYRecibeDosPuntos() {
        ...
        Respuesta primeraRespuestaDelJugador = new RespuestaVerdaderoFalsoClasico(2);
        ...
        Respuesta segundaRespuestaDelJugador = new RespuestaVerdaderoFalsoClasico(2);
